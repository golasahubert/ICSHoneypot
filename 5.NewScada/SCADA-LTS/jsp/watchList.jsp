...
<%-- 
  <c:set var="isRoleAdmin" value="${sessionUser.getAttribute('roles').contains('ROLE_ADMIN')}" />
  <p>isRoleAdmin: <c:out value="${isRoleAdmin}" /></p>
--%>
    ...
    <script type="text/javascript">
      ...
      function addPoint(point, parent) {
          var pointNode = dojo.widget.createWidget("TreeNode", {
                  title: "<img src='images/icon_comp.png'/> <span id='ph"+ point.key +"Name' style='font-size:15px;'>"+ point.value +"</span> "+
    ...
    <tr><td>
      <div id="splitContainer" dojoType="SplitContainer" orientation="horizontal" sizerWidth="3" activeSizing="true" class="borderDiv"
              widgetId="splitContainer" style="width: 97%; height: 500px; resize:vertical; margin-left: 10px;">
    ...
    <tr><td>
      <div id="chartContainer" class="borderDiv" style="width: 97%; resize: vertical; overflow: hidden; height: 500px; margin-left: 10px;">
        <table width="100%">
          <tr>
